...
- **Zones:** `__callbell__/zone-import/` (inputs) and `__callbell__/zone-export/` (requested deliverables), the two volatile buffers. The versioned work trail is `__callbell__/backlog/` (managed state, not a zone).
